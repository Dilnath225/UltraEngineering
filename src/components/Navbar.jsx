        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex-shrink-0 flex items-center">
            <HashLink smooth to="/#home" className="flex items-center gap-3">
              <img src="/logo.png" alt="Ultra Engineering Logo" className="h-12 md:h-14 w-auto rounded-lg shadow-md border border-gray-200 dark:border-gray-700" />

              <div className="flex flex-col">
                <span className="font-extrabold text-xl md:text-2xl leading-none tracking-tight text-gray-900 dark:text-white">ULTRA</span>
